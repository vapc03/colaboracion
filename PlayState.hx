			...
			case 'dashlands':
				{
						defaultCamZoom = 0.9;
						curStage = 'dashlands';
						var bg:FlxSprite = new FlxSprite(-1000, -100).loadGraphic(Paths.image('Geometry Dash/Cubebg'));
						bg.setGraphicSize(Std.int(bg.width * 3.0));
						bg.setGraphicSize(Std.int(bg.height * 3.0));
						bg.antialiasing = true;
						bg.scrollFactor.set(0.9, 0.9);
						bg.active = false;
						add(bg);
					
						var stageFront:FlxSprite = new FlxSprite(-804.15, -400).loadGraphic(Paths.image('Geometry Dash/Cubeground'));
						stageFront.setGraphicSize(Std.int(stageFront.width * 2.0));
						stageFront.setGraphicSize(Std.int(stageFront.height * 2.0));
						...
						if (songLowercase == 'stereo madness'){
